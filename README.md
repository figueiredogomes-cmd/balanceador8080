                                                                                                                                                    ...
                                                                                                                                                    4- Especificações do Ambiente de Homologação
                                                                                                                                                      ...
                                                                                                                                                      Windows 10/11 + WSL 2 (Ubuntu) Intel/AMD x86_64 4 GB Dedicados 10 GB Livres (Geral)
                                                                                                                                                        ...
                                                                                                                                                        * Como executar seguindo
                                                                                                                                                          ...
                                                                                                                                                          Vá no windows 11 ou windows vá em iniciar e digite e abra o powerShell ou digite cmd no windows como Administrador e execute o seguinte comando para instalar o subsistema e a distribuição padrão (Ubuntu):
                        ...
                        Passo 4- No seu navegador ou web browser cole http://localhost:8090/
                          Passo 5- Abra uma janela de terminal paralela no WSL Ubuntu ou no terminal  e execute o encerramento manual da instância para parar os servidores número 2 ou alterando por número 1 ou número 3 :
                                  cd.
                                  cd ..                                                                                                                       cd ~/servico-balanceamento
                                                                                                                                                        sudo docker compose stop servidor2                                                      
                                                                                                                                                        Passo 5
                                                                                                                                                     Cenário de Teste: Recuperação de Serviços (Self-Healing)
                                                                                                                                                      Inicie novamente o serviço que simulou a falha mudando no final do comando por servidor1 , servidor2 ou servidor3 como desejar:
                                                                                                                                                      cd .
                                                                                                                                                      cd ..
                                                                                                                                                      cd ~/servico-balanceamento
                                                                                                                                                       sudo docker compose start servidor1
                                                                                                                                                        Passo 6- Para Remoção de containers entre usando os comandos :
                                                                                                                                                            cd .
                                                                                                                                                            cd ..
                                                                                                                                                            cd servico-balanceamento 
                                                                                                                                                            sudo docker compose down
                                                                                                                                                    Passo 7 - Agora faça um refresh ou ctrl +r  ou f5 e atualize a página pois o navegador gravou essa página em memória temporária e verá que a página não foi encontrado atualmente ou copie e cole http://localhost:8090/  assim verá que a página para de carregar automaticamente .
                                                                                                                                                   Passo 8 - Para se certificar que deu tudo certo de o comando e vai ver que não tem nenhum container instalado :   sudo docker compose ps   
