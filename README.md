                                                                                                                                ...
                                                                                                                                * Como executar seguindo
                                                                                                                                  ...
                                                                                                                                  Passo 3:
                                                                                                                                    ...
                                                                                                                                    Passo 4- No seu navegador ou web browser cole http://localhost:8090/
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    Passo 5-
                                                                                                                                                                                                                                                                  Abra uma janela de terminal paralela no WSL Ubuntu ou no terminal  e execute o encerramento manual da
                                                                                                                                                                                                                                                              instância para parar os servidores número 2 ou alterando por número 1 ou número 3 :
                                                                                                                                                                                                                                                              cd .
                                                                                                                                                                                                                                                              cd ..
                                                                                                                             ...
                                                                                                                             Cenário de Teste: Recuperação de Serviços (Self-Healing)
                                                                                                                              ...
                                                                                                                              cd ~/servico-balanceamento
                                                                                                                               sudo docker compose start servidor1
                                                                                                                                ...
                                                                                                                                Passo 7- Para Remoção de containers entre usando os comandos :
                                                                                                                                    cd .
                                                                                                                                    cd ..
                                                                                                                                    cd servico-balanceamento 
                                                                                                                                ...
                                                                                                                                Passo 8 - Agora faça um refresh ou ctrl +r  ou f5 e atualize a página pois o navegador gravou essa página em memória temporária e verá que a página não foi encontrado atualmente ou copie e cole http://localhost:8090/  assim verá que a página para de carregar automaticamente .
                                                                                                                               
                                                                                                                                Passo 9 - Para se certificar que deu tudo certo de o comando e vai ver que não tem nenhum container instalado :   sudo docker compose ps   
